...
<html lang="en" >
    ...
    <body>
        <c:if test="${requestScope.msg != false}">
            <a href="overview-curriculum?id=${requestScope.c.id}" style="font-size: 16px; background: white; color: black; padding: 8px 16px; border-radius: 8px; margin-left: 5%; text-decoration: none"><i class="fa fa-arrow-left"></i> Back</a>
            <button id="downloadButton" style="position: absolute; top: 3%; right: 5%; padding: 5px 9px; border-radius: 8px ">Download <i class="fa fa-download"></i></button>

            <div class="container pm-certificate-container"  id="targetDiv" style="margin-top:2%">
                <div class="outer-border"></div>
                <div class="inner-border"></div>

                <div class="pm-certificate-border col-xs-12">
                    <div class="row pm-certificate-header">
                        <img src="assets/images/logo-clean.png" style="max-width: 120px; position: absolute; top: 1%; left: 2%" alt="alt"/>
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="pm-certificate-name underline margin-0 col-xs-8 text-center">
                                        <span class="pm-name-text bold" style="font-family: 'Signika', sans-serif;">${requestScope.name}</span>
                                    </div>
                                    <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
                                </div>
                            </div>          
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="pm-earned col-xs-8 text-center">
                                        <span class="pm-earned-text padding-0 block cursive">has successfully completed the online Specialization</span>
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="pm-course-title underline col-xs-8 text-center">
                                        <span class="pm-credits-text block bold sans" style="font-size: 25px; font-family: 'Trocchi', serif;">${requestScope.c.name}</span>
                                    </div>
                                    <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="pm-certificate-footer">
                                    <div class="col-xs-4 pm-certified col-xs-4 text-center">
                                        <span class="pm-credits-text block sans">Byte Scholar System</span>
                                        <span class="pm-empty-space block underline"></span>
                                        <span class="bold block">Ha Noi, Viet Nam</span>
                                    </div>
                                    <div class="col-xs-4">
                                        <!-- LEAVE EMPTY -->
                                    </div>
                                    <div class="col-xs-4 pm-certified col-xs-4 text-center">
                                        <span class="pm-credits-text block sans" style="border-bottom: 1px solid #ccc">Date: ${requestScope.passedDate}</span>

                                        <span class="bold block">Signature </span>
                                        <span style="font-family: 'Cedarville Cursive', cursive;
                                              font-size: 1.8em;">Hieu</span><br/>
                                        <span style="font-family: 'Cedarville Cursive', cursive;
                                              font-size: 1.8em;">Le Minh Hieu</span>
                                        <img style="max-width: 100px; position: absolute; bottom: 1%; right: 70%"
                                             src="assets/images/logo-svg.png" alt="alt"/>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <c:if test="${requestScope.msg == false}">
            <a href="home" style="font-size: 16px; background: white; color: black; padding: 8px 16px; border-radius: 8px; margin-left: 5%; text-decoration: none"><i class="fa fa-arrow-left"></i> Back to Home</a>
            <h2 style="text-align: center;color: #ff0033; font-style: italic">Sorry, nothing here!</h2>
        </c:if>
