                ...
                <div class="page-banner ovbl-dark" style="background-image:url(https://wallpapers.com/images/hd/best-linkedin-background-wqwuzycn1gry742a.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white"><i class="fa fa-weixin"></i> Edit your blog here!</h1>
                        </div>
                    </div>
                </div>
                <!-- Breadcrumb row -->
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9">
                                <form class="contact-bx " action="edit-blog" method="post">
                                    <input type="hidden" name="blogId" value="${b.id}">
                                    <div class="heading-bx left">
                                        <h2 class="title-head">Here <span>is your blog details!</span></h2>
                                    ...
                                    <div class="row placeani">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <label>Title</label>
                                                    <input value="${b.title}" name="title" type="text" required class="form-control ">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <textarea id="file-picker2" name="edit2"><img src="${b.thumbnail}" alt="alt"/></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <h5>Content</h5>
                                                    <textarea id="file-picker" name="edit">${b.content}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                            ...
                                            <c:forEach items="${requestScope.listT}" var="t">
                                                <input class="checkbox-btn" type="checkbox" name="tag" value="${t.id}"
                                                ...
                                                >
                                                <label style="margin-right: 2%">${t.name}</label>
                                            </c:forEach>    


                                        </div>
                                        <div class="col-lg-12">
                                            <input name="submit" type="submit" value="Update" class="btn button-md">
                                        </div>
                                    </div>
                                </form>
                            </div>
