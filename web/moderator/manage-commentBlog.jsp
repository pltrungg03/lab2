    ...
    <main class="ttr-wrapper">
        ...
        <div class="container-fluid">
            <div class="db-breadcrumb">
                <h4 class="breadcrumb-title">Blog Comments</h4>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            dataTableInstance = $('#coursesTable').DataTable({
                ajax: {
                    url: '/SE1735_G5/manage-commentblog',
                    type: 'GET',
                    dataType: 'json',
                    success: function (response) {
                        var list_cmtBlog = JSON.parse(response.listCmtBlog);
                        console.log(list_cmtBlog);
                        dataTableInstance.clear().rows.add(list_cmtBlog).draw();
                    }
                },
                columns: [
                    {data: 'account.email',
            ...
            dataTableInstance.on('click', '#button-56', function () {
                ...
                if (!confirmed) {
                    ...
                    $.ajax({
                        url: "/SE1735_G5/manage-commentblog?cmID=" + id,
                        type: "delete",
                        success: function (response) {
                            filterButtonClickHandler();
