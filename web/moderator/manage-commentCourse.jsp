                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-12">
                                    <div class="db-breadcrumb">
                                        <h4 class="breadcrumb-title">Course Comments</h4>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                dataTableInstance = $('#coursesTable').DataTable({
                    ajax: {
                        url: '/SE1735_G5/manage-commentcourse',
                        type: 'GET',
                        dataType: 'json',
                        success: function (response) {
                            var lisCmtCourse = JSON.parse(response.lisCmtCourse);
                            console.log(lisCmtCourse);
                            dataTableInstance.clear().rows.add(lisCmtCourse).draw();
                        }
                    },
                    columns: [
                        {data: 'account.email',
                ...
                dataTableInstance.on('click', '#button-56', function () {
                    ...
                    if (!confirmed) {
                        ...
                        $.ajax({
                            url: "/SE1735_G5/manage-commentcourse?cmID=" + id,
                            type: "delete",
                            success: function (response) {
                                filterButtonClickHandler();
